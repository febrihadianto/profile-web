        ...
        <div class="row gx-5 align-items-center">
            <div class="col-xxl-5">
                ...
                <div class="text-center text-xxl-start">
                    ...
                    <h1 class="display-3 fw-bolder mb-3"><span class="text-gradient d-inline"> 
                            @if($homepage)
                            {{ $homepage->title }}
                            @else
                            FEBRI HADIANTO
                    ...
                    <div class="fs-5 fw-light text-muted mb-2">
                        @if($homepage)
            ...
            <div class="col-xxl-7">
                ...
                <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                    <div class="profile bg-gradient-primary-to-secondary">
                        ...
                        @if($homepage)
                        <img class="profile-img" src="/storage/img/{{ $homepage->image }}"
                            alt="{{ $homepage->title }}" />
                        @endif
                        <div class="dots-1">
                            <!-- SVG Dots-->
